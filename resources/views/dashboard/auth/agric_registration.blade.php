...
@section('title', 'Agriculture Retailer Registration')
@section('content')
    <style>
    ...
    <main role="main" class="ion-checkout">
        ...
        <div class="card mb-6">
            <div class="card-header font-weight-bold text-center text-white bg-success">
                Agriculture Retailer Registration
            </div>
            <div class="card-body p-0">
                <form action="{{ route('dashboard.uploadAgriRetailerRegData') }}" autocomplete="off" method="post"
                    class="p-2">
                    ...
                    <div class="ion-list ion-no-margin">
                        <div class="text-field">
                            <input required pattern="[6789][0-9]{9}" min="10" maxlength="10" type="tel" required
                                name="mobile" title="Mobile" value="{{ old('mobile') }}" />
                        ...
                        <div class="ion-list ion-no-margin">
                            <div class="text-field">
                                <input type="text" required name="address" title="Full Address"
                                    value="{{ old('address') }}" />
                        ...
                        <div class="ion-list ion-no-margin">
                            <div class="text-field">
                                <input type="text" required name="panchayat" title="Panchayat"
                                    value="{{ old('panchayat') }}" />
                        ...
                        <div class="ion-list ion-no-margin">
                            <div class="text-field">
                                <input type="text" required name="pin_code" title="Panchayat"
                                    value="{{ old('pin_code') }}" />
                        ...
                        {{-- <div class="ion-list ion-no-margin">
                            <div class="text-field">
                                <input type="text" required name="experience" title="Experience"
